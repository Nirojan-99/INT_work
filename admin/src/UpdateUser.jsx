...
function UpdateUser(){
    ...
    const Update = (e) => {
        e.preventDefault();
        axios.put("http://localhost:3001/updateUser/"+id,{code,name,value,description,minOrder,maxOrder,couponType,status,restrictEmail,noItem,usageLimit,couponQuantity,startDate,endDate})
        .then(result => {
            Swal.fire({
                position: 'center',
                icon: 'success',
