...
function Payment() {
    ...
    const handleApprove = async (id) => {
        try {
          await Axios.put(`http://localhost:8070/payment/update/${id}`, { newStatus: 'approved' });
      ...
      const handleReject = async (id) => {
        try {
          await Axios.put(`http://localhost:8070/payment/update/${id}`, { newStatus: 'rejected' });
          // No need to set the status state here, as it's not used in this context
          window.location.reload();
        } catch (error) {
          console.error('Error updating status:', error);
                                ...
                                return (
                                    <tr key={key}>
                                        ...
                                        <td>{val.Status}</td>
                                         ...
                                         <td><button type='button' className="btn btn-outline-success btn-sm" onClick={()=>handleApprove(val._id)}>Approve</button></td>
                                         <td><button type='button' className="btn btn-outline-danger btn-sm" onClick={()=>handleReject(val._id)}>Reject</button></td>
                        ...
                        <div className="modal-dialog modal-dialog-centered">
                            <div className="modal-content">
                                ...
                                <div className="modal-footer">
                                    ...
                                    <button type="button" className="btn btn-primary" onClick={() => updatePayment( )}>Update</button>
                                </div>
                            </div>
