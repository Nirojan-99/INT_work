...
export const login = (email, password) => async (dispatch) => {
        ...
        try {
            ...
            const { data }  = await axios.post(`http://localhost:8070/api/v1/login`,{email,password});
...
export const register = (userData) => async (dispatch) => {
    ...
    try {
        ...
        const { data }  = await axios.post(`http://localhost:8070/api/v1/register`,userData, config);
